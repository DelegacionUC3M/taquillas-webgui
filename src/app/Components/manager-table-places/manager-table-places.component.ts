...
import { ManagerTablePlacesDataSource } from './manager-table-places-datasource';

@Component({
    selector: 'manager-table-places',
    templateUrl: './manager-table-places.component.html',
    styleUrls: ['./manager-table-places.component.css']
})
export class ManagerTablePlacesComponent implements OnInit {
    @ViewChild(MatPaginator) paginator: MatPaginator;
    @ViewChild(MatSort) sort: MatSort;
    dataSource: ManagerTablePlacesDataSource;
    ...
    ngOnInit() {
        this.publicApiService.getPlaces().subscribe(
            result => {
                this.dataSource = new ManagerTablePlacesDataSource(result, this.paginator, this.sort);   
            }
        ); 
    }
