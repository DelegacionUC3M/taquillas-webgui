 ...
 */
export class ManagerTableLockersDataSource extends DataSource<Locker> {
     ...
     */
    private getPagedData(data: Locker[]) {
     ...
     * this would be replaced by requesting the appropriate data from the server.
     */
    private getSortedData(data: Locker[]) {
        ...
        return data.sort((a, b) => {
            ...
            switch (this.sort.active) {
                ...
                case 'incidence': return compare(+a.incidence, +b.incidence, isAsc);
                case 'qr': return compare(+a.qr, +b.qr, isAsc);
                default: return 0;
            }
        });
    }
